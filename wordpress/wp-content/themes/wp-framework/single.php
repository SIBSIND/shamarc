            ...
            <div>
                <div class="panel-content">
                    ...
                    <p class="text-warning">
                        ...
                        Выдача адреса производиться на этой странице автоматически, либо на странице "Проверка заказа"" по выданному номеру заказа и присвоенному комментарию.
                        Если Вы случайно закрыли данную страницу, воспользуйтесь страницей "Проверка заказа".
